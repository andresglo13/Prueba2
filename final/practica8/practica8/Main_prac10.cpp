...
char back[17]="SkyBox/backD.tga";
char bottom[19] = "SkyBox/bottomD.tga";
char front[18] = "SkyBox/frontD.tga";
char Sleft[18] = "SkyBox/leftD.tga";
char Sright[18] = "SkyBox/rightD.tga";
char top[16] = "SkyBox/topD.tga";
...
int main()
{
	...
	faces.push_back(Sleft);
	faces.push_back(Sright);
	faces.push_back(top);
